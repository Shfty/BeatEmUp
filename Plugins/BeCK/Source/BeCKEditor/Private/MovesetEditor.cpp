...
{
	WorkspaceMenuCategory = InTabManager->AddLocalWorkspaceMenuCategory(LOCTEXT("WorkspaceMenu_MovesetEditor", "BeCK Moveset Editor"));
...
{
	return FName("BeCK MovesetEditor");
}

FText FMovesetEditor::GetBaseToolkitName() const
{
	return LOCTEXT("AppLabel", "BeCK Moveset Editor");
}

FString FMovesetEditor::GetWorldCentricTabPrefix() const
{
	return LOCTEXT("WorldCentricTabPrefix", "BeCK Moveset ").ToString();
}
...
{
	const FScopedTransaction Transaction(NSLOCTEXT("UnrealEd", "MovesetEditorDeleteSelectedNode", "Delete Selected BeCK Moveset Node"));
...
{
	// Undo/Redo support
	const FScopedTransaction Transaction(NSLOCTEXT("UnrealEd", "MovesetEditorPaste", "Paste BeCK Moveset Node"));
