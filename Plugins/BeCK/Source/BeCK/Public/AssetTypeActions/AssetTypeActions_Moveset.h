...
public:
	...
	virtual FText GetName() const override { return NSLOCTEXT("AssetTypeActions", "AssetTypeActions_Moveset", "BeCK Moveset"); }
...
void FAssetTypeActions_Moveset::OpenAssetEditor(const TArray<UObject*>& InObjects, TSharedPtr<IToolkitHost> EditWithinLevelEditor)
{
	...
	for(auto ObjIt = InObjects.CreateConstIterator(); ObjIt; ++ObjIt)
	{
		...
		if(Moveset != nullptr)
		{
			FBeCKEditorModule* SandboxEditorModule = &FModuleManager::LoadModuleChecked<FBeCKEditorModule>("BeCKEditor");
