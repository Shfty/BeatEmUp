...
class BEATEMUP_API UFrameData : public UObject
{
	GENERATED_BODY()
...
UCLASS()
class BEATEMUP_API UHitboxFrames : public UFrameData
{
	GENERATED_BODY()
...
UCLASS()
class BEATEMUP_API UArmorFrames : public UFrameData
{
	GENERATED_BODY()
...
UCLASS()
class BEATEMUP_API UInvincibilityFrames : public UFrameData
{
	GENERATED_BODY()
...
UCLASS()
class BEATEMUP_API ULinkFrames : public UFrameData
{
	GENERATED_BODY()
...
UCLASS()
class BEATEMUP_API UMotionFrames : public UFrameData
{
	GENERATED_BODY()
...
UCLASS()
class BEATEMUP_API UImpulseFrames : public UFrameData
{
	GENERATED_BODY()
...
UCLASS()
class BEATEMUP_API UMovementPropertyFrames : public UFrameData
{
	GENERATED_BODY()
