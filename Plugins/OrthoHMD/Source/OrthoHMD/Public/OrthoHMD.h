 ...
 */
class FOrthoHMD : public IHeadMountedDisplay, public ISceneViewExtension, public TSharedFromThis<FOrthoHMD, ESPMode::ThreadSafe>
{
public:
	/** IHeadMountedDisplay interface */
	virtual FName GetDeviceName() const override
	{
		static FName DefaultName(TEXT("OrthoHMD"));
		return DefaultName;
	}
