...
USTRUCT()
struct BECKEDITOR_API FMovesetGraphSchemaAction_NewNode : public FEdGraphSchemaAction
{
...
USTRUCT()
struct BECKEDITOR_API FMovesetGraphSchemaAction_NewFromSelected : public FMovesetGraphSchemaAction_NewNode
{
	GENERATED_USTRUCT_BODY();
...
USTRUCT()
struct BECKEDITOR_API FMovesetGraphSchemaAction_NewComment : public FEdGraphSchemaAction
{
	GENERATED_USTRUCT_BODY();
...
USTRUCT()
struct BECKEDITOR_API FMovesetGraphSchemaAction_Paste : public FEdGraphSchemaAction
{
	GENERATED_USTRUCT_BODY();
